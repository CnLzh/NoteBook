- [I/O多路复用](#io多路复用)
  - [关于同步/异步，阻塞/非阻塞](#关于同步异步阻塞非阻塞)
    - [同步和异步](#同步和异步)
    - [阻塞和非阻塞](#阻塞和非阻塞)
    - [总结](#总结)
  - [I/O多路复用之select、poll、epoll](#io多路复用之selectpollepoll)
    - [1.select模型](#1select模型)
      - [C++中的select函数](#c中的select函数)
    - [2.poll模型](#2poll模型)
      - [C++中的poll函数](#c中的poll函数)
    - [3.epoll模型](#3epoll模型)
      - [C++中的epoll函数](#c中的epoll函数)
      - [epoll的同步阻塞和同步非阻塞](#epoll的同步阻塞和同步非阻塞)
  - [Reactor模式](#reactor模式)
    - [1.单Reactor单线程](#1单reactor单线程)
      - [执行流程](#执行流程)
      - [分析](#分析)
    - [2.单Reactor多线程](#2单reactor多线程)
      - [执行流程](#执行流程-1)
      - [分析](#分析-1)
    - [3.主从Reactor多线程](#3主从reactor多线程)
      - [执行流程](#执行流程-2)
      - [分析](#分析-2)
